...
// 64 bit data -> 64 bit data
        ...
        //-----------------------------------------------------------------------------
        void Permutate(unsigned char* pData, unsigned char ni,
            unsigned char* pTable, unsigned char no);
        void LeftShift(unsigned char* nKey, unsigned char b);
        void RightShift(unsigned char* nKey, unsigned char b);
        void Expand(unsigned char* R);
        void F(unsigned char* R, unsigned char* K);
		//-----------------------------------------------------------------------------
	public:
		void Encrypt(unsigned char *dMes,unsigned char *dKey); // DES encryption
		void Decrypt(unsigned char *dMes,unsigned char *dKey); // DES decryption
		void Encrypt(unsigned char *dMes,unsigned char *dKeyL,unsigned char *dKeyR);// TDES encryption
		void Decrypt(unsigned char *dMes,unsigned char *dKeyL,unsigned char *dKeyR);// TDES decryption
	};
} // namespace ce 
#endif // CEDES_H